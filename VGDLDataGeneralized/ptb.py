...
class PTB(Dataset):
    ...
    def __init__(self, data_dir, split, create_data, **kwargs):
        ...
        self.split = split
        self.max_sequence_length = kwargs.get('max_sequence_length', 600)
        self.min_occ = kwargs.get('min_occ', 3)

        self.raw_data_path = os.path.join(data_dir, 'ptb.'+split+'.csv')
    ...
    def _file_to_words(self, file_name):
        file = open(file_name)
        desc = file.readlines()
        words = []
    ...
    def _get_words(self):
        ...
        with open(self.raw_data_path) as csv_file:
            csv_reader = csv.reader(csv_file, delimiter=',')
            for row in csv_reader:
                words.append(self._file_to_words(self.data_dir + "/" + row[1])) 
        return words
    ...
    def _create_data(self):
        ...
        for i, words in enumerate(self._get_words()):
